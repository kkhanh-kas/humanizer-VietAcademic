# Evaluation Rubric for Vietnamese Academic Rewriting

This rubric evaluates the quality and fidelity of humanized Vietnamese academic prose.

## The 10 Evaluation Criteria (0–5 scale each)

1. **Naturalness (Độ tự nhiên):** Does the text read as though composed directly by a native Vietnamese scholar rather than machine translated?
2. **Clarity (Độ rõ ràng):** Is the academic argument straightforward and devoid of convoluted syntax?
...
## Critical Blockers (Immediate Score = 0)

- Loss, displacement, or fabrication of reference citations (`[1]`, `(Author, Year)`).
- Fabrication of new factual, numerical, or statistical claims.
- Alteration of scientific confidence level (e.g., converting a tentative hypothesis into a definitive conclusion or vice versa).
- Presence of raw chatbot preamble/postamble in final deliverables.
